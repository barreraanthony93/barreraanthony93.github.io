...
function collapseNavbar() {
    $(".navbar").offset().top > 50 ? $(".navbar-fixed-top, .socialTop, .btn-lg-out").addClass("top-nav-collapse") : $(".navbar-fixed-top, .socialTop, .btn-lg-out").removeClass("top-nav-collapse")
}
