...
//        here
        _createListItem: function (b) {
            ...
            return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'>" + b.title + (b.mp3 ? "<a class = 'jp-download' href=" + b.mp3 + " download>&ensp;AUDIO</a>" : "") + (b.download ? "<a class = 'jp-download' href=" + b.download + "> PDF |</a>" : "") + (b.artist ? " <span class='jp-artist'>by " + b.artist + "</span>" : "") + "</a>", d += "</div></li>"
        },
